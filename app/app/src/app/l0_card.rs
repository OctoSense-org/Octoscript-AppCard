...
const KIT_BODY: &str = include_str!(concat!(env!("OCTOSENSE_WORKSPACE"), "/octoscript-makepad/components/l0/_kit.octoscript"));
...
const PALETTE_DERIVE_COLOR: &str =
    include_str!(concat!(env!("OCTOSENSE_WORKSPACE"), "/octoscript-makepad/components/l0/_derive_color.octoscript"));
...
const PALETTES: &[(&str, &str)] = &[
    ("dark", ""),
    ("light", include_str!(concat!(env!("OCTOSENSE_WORKSPACE"), "/octoscript-makepad/components/l0/_palette_light.octoscript"))),
    ("glass", include_str!(concat!(env!("OCTOSENSE_WORKSPACE"), "/octoscript-makepad/components/l0/_palette_glass.octoscript"))),
    ("photo", include_str!(concat!(env!("OCTOSENSE_WORKSPACE"), "/octoscript-makepad/components/l0/_palette_photo.octoscript"))),
    ("vibrant", include_str!(concat!(env!("OCTOSENSE_WORKSPACE"), "/octoscript-makepad/components/l0/_palette_vibrant.octoscript"))),
    ("minimal", include_str!(concat!(env!("OCTOSENSE_WORKSPACE"), "/octoscript-makepad/components/l0/_palette_minimal.octoscript"))),
    // Theme packs — kits imported whole (palette + scale + family + depth).
    ("atro", include_str!(concat!(env!("OCTOSENSE_WORKSPACE"), "/octoscript-makepad/components/l0/_palette_atro.octoscript"))),
    ("atro_light", include_str!(concat!(env!("OCTOSENSE_WORKSPACE"), "/octoscript-makepad/components/l0/_palette_atro_light.octoscript"))),
    ("camo", include_str!(concat!(env!("OCTOSENSE_WORKSPACE"), "/octoscript-makepad/components/l0/_palette_camo.octoscript"))),
    ("camo_light", include_str!(concat!(env!("OCTOSENSE_WORKSPACE"), "/octoscript-makepad/components/l0/_palette_camo_light.octoscript"))),
    ("taskplan_light", include_str!(concat!(env!("OCTOSENSE_WORKSPACE"), "/octoscript-makepad/components/l0/_palette_taskplan_light.octoscript"))),
];
...
macro_rules! accent {
    ($hue:literal, $mood:literal) => {
        ($hue, $mood, include_str!(concat!(
            env!("OCTOSENSE_WORKSPACE"), "/octoscript-makepad/components/l0/_axis_accent_",
...
macro_rules! axis {
    ($axis:literal, $value:literal) => {
        ($axis, $value, include_str!(concat!(
            env!("OCTOSENSE_WORKSPACE"), "/octoscript-makepad/components/l0/_axis_",
...
mod exemplar_drift {
    ...
    const FIXTURE: &str =
        include_str!(concat!(env!("OCTOSENSE_WORKSPACE"), "/octoscript/crates/octoscript-ui-l0/tests/fixtures/nav.card"));
